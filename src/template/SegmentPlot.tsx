...
import { DEFAULT_BAR_TEMPLATE } from '../components/BarPlot';
    ...
    switch (child.type){
      ...
      case PlotAreaTemplate:
        return {
          type: "bar-content-container",
          ...props,
          elements: child.props.children ? generateTemplate(child.props.children) : DEFAULT_SEGMENT_PLOTAREA_TEMPLATE,
        } as BarContentContainerElementType
      case BarsAndDecsTemplate:
        return {
          type: "bar-dec-container",
          ...props,
          elements: child.props.children ? generateTemplate(child.props.children) : DEFAULT_SEGMENT_BARSANDDECS_ELEMENTS_TEMPLATE,
